...
<div class="panel  panel-info">
    <div class="panel-heading">
	 ...
	 <div class="panel-body">
         <div class="row " >
             <div class="col-xs-10">
                 <form action="{{URL::to('manage/order/supplier_back_list')}}" method="get">
    ...
    <table class="table  table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
					<a class="btn btn-success btn-xs"  href="{{URL::to('manage/order/supplier_back_list_view')}}/{{ $list->back_id }}"><i class="glyphicon glyphicon-search"></i>查看</a>
                </td>
            </tr>
            @endforeach
        </tbody>
...
<script>
    ...
    function button(){
      ...
      $.ajax({
            ...
            success:function(e){
                alert(e);
                setTimeout(window.location.href='/manage/order/supplier_back_list',100);
            }
        });
    }
</script>
