        ...
        <form method="post"
                ...
                <div class="row">
                    <div class="col-md-6">
                                            ...
                                            <select class="form-control " name="cat_id">
                                                ...
                                                @foreach ($cat as $c)
                                                    <option value="{{ $c->cat_id }}"
                                                            @if(isset($goods->cat_id)&&$goods->cat_id==$c->cat_id) selected @endif>{{ $c->cat_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        @if(!empty($goods->gallery))
                                            @foreach($goods->gallery as $v)
                                                <div class='thumbnail img-contianer'>
                                                    <img src='{{$v->img_url}}?imageView2/1/w/150/h/150'
                                                         class='img img-rounded' width='150' height='150'/>
                                                    <span class='remove_img' onclick='mydelete(this)'><i
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                            <textarea id="editor" name="goods_desc" placeholder="商品介绍"
                                ...
                                <table class="table table-striped table-hover table-bordered"
                                    ...
                                    @if(isset($goods->item))
                                        @foreach($goods->item as $v)
                                            <tr>
                                                <td><input type="text" name="keyname[]" value="{{$v->key}}"
                                                           class="form-control" placeholder="属性名"></td>
                                                <td><input type="text" name="keyvalue[]" value="{{$v->value}}"
                                                           class="form-control" placeholder="属性数据"></td>
                                                <td><input type="number" name="stor[]" value="{{$v->stor}}"
                                                           class="form-control" placeholder="排序"></td>
                                                <td>
                                    ...
                                    @else
                                        <tr>
                                            <td><input type="text" name="keyname[]" class="form-control"
                                                       placeholder="属性名"></td>
                                            <td><input type="text" name="keyvalue[]" class="form-control"
                                                       placeholder="属性数据"></td>
                                            <td><input type="number" name="stor[]" class="form-control"
                                                       placeholder="排序"></td>
                                            <td>
                                                <button class="btn btn-danger" data-id="8"
                                                        onclick='deleteParam(this)'><i class="fa fa-remove"></i>删除
                                ...
                                <table class="table table-striped table-hover table-bordered"
                                    ...
                                    @if(isset($goods->attr))
                                        @foreach($goods->attr as $k=>$v)
                                            <tr class="tr_{{$k}}">
                                                <td rowspan="{{count($v)}}">
                                                    <input type="text" class="form-control" name="attr_name[tr_{{$k}}]"
                                                           placeholder="例如:原味" value="{{$k}}">
                                                </td>
                                                <td><input type="text" name="attr_value[tr_{{$k}}][]"
                                                           class="form-control" placeholder="例如:1盒装"
                                                           value="{{$v[0]['attr_value']}}"></td>
                                                <td><input type="text" name="attr_number[tr_{{$k}}][]"
                                                           class="form-control" placeholder="库存"
                                                           value="{{$v[0]['goods_number']}}"></td>
                                                <td><input type="text" name="attr_market[tr_{{$k}}][]"
                                                           class="form-control" placeholder="原价"
                                                           value="{{$v[0]['market_price']}}"></td>
                                                <td><input type="text" name="attr_price[tr_{{$k}}][]"
                                                           class="form-control" placeholder="现价"
                                                           value="{{$v[0]['shop_price']}}"></td>
                                                <td>
                                                    <button class="btn  btn-sm btn-info " type="button"
                                                            onclick="addFormatRow(this)">
                                            ...
                                            @foreach($v as $kk=>$vv)
                                                @if($kk<>0)
                                                    <tr>
                                                        <td><input type="text" name="attr_value[tr_{{$k}}][]"
                                                                   class="form-control" placeholder="例如:1盒装"
                                                                   value="{{$vv['attr_value']}}"></td>
                                                        <td><input type="text" name="attr_number[tr_{{$k}}][]"
                                                                   class="form-control" placeholder="库存"
                                                                   value="{{$vv['goods_number']}}"></td>
                                                        <td><input type="text" name="attr_market[tr_{{$k}}][]"
                                                                   class="form-control" placeholder="原价"
                                                                   value="{{$vv['market_price']}}"></td>
                                                        <td><input type="text" name="attr_price[tr_{{$k}}][]"
                                                                   class="form-control" placeholder="现价"
                                                                   value="{{$vv['shop_price']}}"></td>
                                                        <td>
                                    ...
                                    @else
                                        <tr class="tr_1">
                                            <td rowspan="2">
                                                <input type="text" class="form-control" name="attr_name[tr_1]"
                                                       placeholder="例如:原味">
                                            </td>
                                            <td><input type="text" name="attr_value[tr_1][]" class="form-control"
                                                       placeholder="例如:1盒装"></td>
                                            <td><input type="text" name="attr_number[tr_1][]" class="form-control"
                                                       placeholder="库存"></td>
                                            <td><input type="text" name="attr_market[tr_1][]" class="form-control"
                                                       placeholder="原价"></td>
                                            <td><input type="text" name="attr_price[tr_1][]" class="form-control"
                                                       placeholder="现价"></td>
                                            <td>
                                                <button class="btn  btn-sm btn-info " type="button"
                                                        onclick="addFormatRow(this)">
            ...
            <div class="panel-footer">
                <div class="row text-right" style="padding-right: 10px">
                    <a href="javascript:history.go(-1)" class="btn btn-info btn-lg"><i class="fa fa-mail-reply-all"></i>
                        返回
                    </a>
                </div>
            </div>
