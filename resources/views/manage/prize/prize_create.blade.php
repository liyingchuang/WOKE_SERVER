    ...
    <div class="panel-body">
        <div class="tabbable">
            <div class="tab-content">
                <form method="post"  action="{{URL::to('manage/prize/add')}}" class="form-horizontal" id="html5Form" data-bv-message="数据不能为空" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control required safe-input" id="num" name="num" placeholder="商品数量" required="" min="0" data-bv-greaterthan-inclusive="false" data-bv-greaterthan-message="请输入大于1" data-bv-lessthan-inclusive="true" data-bv-message="商品数量不为空"  >
                        </div>
                    ...
                    <div class="form-group" style="display:none;" id="trade">
                        <label for="disabledSelect"  class="col-sm-2 control-label">兑换所需：</label>
                        <div class="col-sm-2">
                            <input type="text" value="0" class="form-control required safe-input" id="fragment" name="fragment" required="" data-bv-notempty-message="用户所得不能为空" placeholder="用户所得数量" min="-1" data-bv-greaterthan-inclusive="false" data-bv-greaterthan-message="不能输入比0少的" data-bv-lessthan-inclusive="true" data-bv-message="碎片数量不为空">
                        </div>
                        <label for="disabledSelect"  class="col-sm-1 control-label">兑换物品：</label>
                        <div class="col-sm-2">
                            <select name="trade_goods" id="trade_goods"  class="form-control" required="" data-bv-notempty-message="不能为空" >
                                <option value="0">请选择</option>
                            </select>
                        </div>
                        <div class="col-sm-5"></div>
                    </div>
                    <div class="form-group" style="display:none;" id="integral">
                        <label for="disabledSelect"  class="col-sm-2 control-label">最小积分：</label>
                        <div class="col-sm-2">
                            <input type="text" value="" class="form-control required safe-input" id="min" name="min" required="" data-bv-notempty-message="最小积分" placeholder="最小积分" data-bv-greaterthan-inclusive="false" data-bv-greaterthan-message="不能输入比0少的" data-bv-lessthan-inclusive="true" data-bv-message="最小积分不为空">
                        </div>
                        <label for="disabledSelect"  class="col-sm-1 control-label">最大积分：</label>
                        <div class="col-sm-2">
                            <input type="text" value="" class="form-control required safe-input" id="max" name="max" required="" data-bv-notempty-message="最大积分" placeholder="最大积分" data-bv-greaterthan-inclusive="false" data-bv-greaterthan-message="不能输入比0少的" data-bv-lessthan-inclusive="true" data-bv-message="最大积分不为空">
                        </div>
                        <div class="col-sm-5"></div>
                    </div>
